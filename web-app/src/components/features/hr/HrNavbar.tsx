    ...
    <header className="sticky top-0 z-40 border-b border-slate-700/60 bg-slate-900 text-white shadow-md">
      <div className="container mx-auto flex h-14 max-w-7xl items-center justify-between px-4">
        ...
        <Link href="/hr-dashboard" className="flex items-center space-x-2.5 transition-opacity hover:opacity-90">
          <div className="flex size-8 items-center justify-center rounded-lg overflow-hidden bg-white">
            <Image
              src="/logo.png"
              alt="Smile Interview Logo"
              width={32}
              height={32}
        ...
        <div className="flex items-center space-x-2">
          ...
          <Link
            href="/hr-dashboard"
            className="hidden sm:flex items-center space-x-1.5 rounded-lg px-3 py-1.5 text-xs font-medium text-slate-300 hover:bg-slate-800 hover:text-white transition-colors"
          >
          ...
          {user ? (
            <div className="relative">
              ...
              >
                ...
                <span className="max-w-[100px] truncate font-semibold">{user.username}</span>
                <ChevronDown className="size-3.5 text-slate-400" />
              </button>

              {dropdownOpen && (
                <div className="absolute right-0 mt-2 w-52 rounded-xl border border-slate-700 bg-slate-900 p-2 shadow-xl z-50 text-xs space-y-1">
